...
func TestUpdate(t *testing.T) {
	...
	// Update status
	updated, err := issueSvc.Update(ctx, issue.ID, "done", nil, nil, nil, nil, nil)
	if err != nil {
	...
	// Update assignee
	updated, err = issueSvc.Update(ctx, issue.ID, "", &agent.ID, nil, nil, nil, nil)
	if err != nil {
...
func TestUpdateInvalidStatus(t *testing.T) {
	...
	_, err = issueSvc.Update(ctx, issue.ID, "invalid_status", nil, nil, nil, nil, nil)
...
func TestUpdateDocuments(t *testing.T) {
	...
	updated, err := issueSvc.Update(ctx, issue.ID, "", nil, nil, nil, &docs, nil)
	if err != nil {
	...
	emptyDocs := []any{}
	updated2, err := issueSvc.Update(ctx, issue.ID, "", nil, nil, nil, &emptyDocs, nil)
	if err != nil {
	...
	updated3, err := issueSvc.Update(ctx, issue.ID, "", nil, nil, nil, nil, &wps)
	if err != nil {
	...
	emptyWPs := []any{}
	updated4, err := issueSvc.Update(ctx, issue.ID, "", nil, nil, nil, nil, &emptyWPs)
	if err != nil {
