...
## Original Rules for Development Agentic Skills, Agents, and Agent Tools
See original rules in `AGENTS.orig.md` for context; but avoid loading the file unnecessarily if not working on agents.
